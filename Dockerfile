...
SHELL ["conda", "run", "-n", "coreference_resolution_api", "/bin/bash", "-c"]
...
ENTRYPOINT ["conda", "run", "--no-capture-output", "-n", "coreference_resolution_api", "uvicorn", "main:app", "--host", "0.0.0.0", "--port", "5000"]